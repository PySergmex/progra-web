...
// Manejo del contador con cookies
if (!isset($_COOKIE["contador_cookies"])) {
    $contador = 1;
} else {
    $contador = $_COOKIE["contador_cookies"] + 1;
}

// Actualizar cookie
setcookie("contador_cookies", $contador, time() + 60); 
// 60 segundos. Si quieres más tiempo me dices.
...
<div class="container mt-5 text-center">
    ...
    <h2>Cookies — Contador de visitas</h2>

    <p class="mt-3">
        Esta página cuenta cuántas veces has entrado usando <strong>cookies</strong>.
    </p>
    ...
    <div class="mt-4 d-flex justify-content-center gap-3">
        ...
        <a href="destroy_cookie.php" class="btn btn-warning">Reiniciar Cookie</a>
